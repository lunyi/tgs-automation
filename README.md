...
```
cd existing_repo
git remote add origin https://gitlab.com/rayprosoft/tgs-automation.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/rayprosoft/tgs-automation/-/settings/integrations)
